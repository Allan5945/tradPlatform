            ...
            <div class="choose">
                    ...
                    <div class="second" v-show="secondShow">
                        <div class="start item" v-show="second1Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a" id="alWairAYes1" @change="dptAcceptnearairport = 0"><label for="alWairAYes1" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a" id="alWairANo1" checked @change="dptAcceptnearairport = 1"><label for="alWairANo1" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
                                ...
                                <div class="resource-time">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a-res" id="alWairAResYes1" checked @click="dptTimeresourcesFn0"><label for="alWairAResYes1" class="input-label">有</label>
                                    </div>
                                ...
                                <div class="resource-others">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a-res" id="alWairAWait1" @click="dptTimeresourcesFn1"><label for="alWairAWait1" class="input-label">待协调</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a-res" id="alWairAEnough1" @click="dptTimeresourcesFn2"><label for="alWairAEnough1" class="input-label">时刻充足</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="pass item" v-show="second2Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b" id="alWairBYes1" @change="pstAcceptnearairport = 0"><label for="alWairBYes1" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b" id="alWairBNo1" checked @change="pstAcceptnearairport = 1"><label for="alWairBNo1" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
                                ...
                                <div class="resource-time">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b-res" id="alWairBResYes1" checked @click="pstTimeresourcesFn0"><label for="alWairBResYes1" class="input-label">有</label>
                                    </div>
                                ...
                                <div class="resource-others">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b-res" id="alWairBWait1" @click="pstTimeresourcesFn1"><label for="alWairBWait1" class="input-label">待协调</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b-res" id="alWairBEnough1" @click="pstTimeresourcesFn2"><label for="alWairBEnough1" class="input-label">时刻充足</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="arrive item" v-show="second3Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c" id="alWairCYes1" @change="arrvAcceptnearairport = 0"><label for="alWairCYes1" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c" id="alWairCNo1" checked @change="arrvAcceptnearairport = 1"><label for="alWairCNo1" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
                                ...
                                <div class="resource-time">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c-res" id="alWairCResYes1" checked @click="arrvTimeresourcesFn0"><label for="alWairCResYes1" class="input-label">有</label>
                                    </div>
                                ...
                                <div class="resource-others">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c-res" id="alWairCWait1"  @click="arrvTimeresourcesFn1"><label for="alWairCWait1" class="input-label">待协调</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c-res" id="alWairCEnough1" @click="arrvTimeresourcesFn2"><label for="alWairCEnough1">时刻充足</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="third items bg-color">
                    ...
                    <div class="third-d item">
                        <div class="right item-child">
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <div class="vertical-center" style="margin-bottom: 10px;">
                                    <input type="radio" class="magic-radio" name="subsidy" id="alWsubsidyYes1" checked/><label for="alWsubsidyYes1" class="input-label">有补贴</label>
                                ...
                                <div style="display: flex">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="subsidy" id="alWsubsidyNo1" @click="subsidyClick1"/><label for="alWsubsidyNo1" class="input-label">无补贴</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="subsidy" id="alWsubsidyTalk1" @click="subsidyClick2"/><label for="alWsubsidyTalk1" class="input-label">可面谈</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="left item-child">
                            <div class="vertical-center">
                                <input type="checkbox" class="magic-radio" id="alWacceptDispatch1" v-model="schedulingShow" @click="schedulingShowFn"/>
                                <label for="alWacceptDispatch1" class="input-label" style="white-space: nowrap;">接受调度</label>
                            </div>
    ...
    export default {
        ...
        computed: {
            num: function () { // 其他说明中已输入的字数
                return this.remarkMsg.length <= 35? this.remarkMsg.length: 35;
            },
        ...
        methods: {
            ...
            acceptDataFn: function () {
                /*单选按钮是否选定*/
                let alWairAYes = document.getElementById('alWairAYes1');
                let alWairANo = document.getElementById('alWairANo1');
                let alWairAResYes = document.getElementById('alWairAResYes1');
                let alWairAWait = document.getElementById('alWairAWait1');
                let alWairAEnough = document.getElementById('alWairAEnough1');
                let alWairBYes = document.getElementById('alWairBYes1');
                let alWairBNo = document.getElementById('alWairBNo1');
                let alWairBResYes = document.getElementById('alWairBResYes1');
                let alWairBWait = document.getElementById('alWairBWait1');
                let alWairBEnough = document.getElementById('alWairBEnough1');
                let alWairCYes = document.getElementById('alWairCYes1');
                let alWairCNo = document.getElementById('alWairCNo1');
                let alWairCResYes = document.getElementById('alWairCResYes1');
                let alWairCWait = document.getElementById('alWairCWait1');
                let alWairCEnough = document.getElementById('alWairCEnough1');
                let alWsubsidyYes = document.getElementById('alWsubsidyYes1');
                let alWsubsidyNo = document.getElementById('alWsubsidyNo1');
                let alWsubsidyTalk = document.getElementById('alWsubsidyTalk1');
                let alWacceptDispatch = document.getElementById('alWacceptDispatch1');
                ...
                if(this.scheduling === "0") {
                    ...
                    if(this.acceptData.airportForSchedulines){
                        this.fifthArea = this.acceptData.airportForSchedulines[0].airlnCd;
