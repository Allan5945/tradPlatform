                    ...
                    <div class="second" v-show="secondShow">
                        <div class="start item" v-show="second1Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a" id="mPubEairAYes" @change="dptAcceptnearairport = 0"><label for="mPubEairAYes" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a" id="mPubEairANo" checked @change="dptAcceptnearairport = 1"><label for="mPubEairANo" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
                                ...
                                <div class="resource-time">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a-res" id="mPubEairAResYes" :checked="time11Checked" @click="dptTimeresourcesFn0"><label for="mPubEairAResYes" class="input-label">有</label>
                                    </div>
                                ...
                                <div class="resource-others">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a-res" id="mPubEairAWait" :checked="time12Checked" @click="dptTimeresourcesFn1"><label for="mPubEairAWait" class="input-label">待协调</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a-res" id="mPubEairAEnough" :checked="time13Checked" @click="dptTimeresourcesFn2"><label for="mPubEairAEnough" class="input-label">时刻充足</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="pass item" v-show="second2Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b" id="mPubEairBYes" @change="pstAcceptnearairportFn0"><label for="mPubEairBYes" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b" id="mPubEairBNo" checked @change="pstAcceptnearairportFn1"><label for="mPubEairBNo" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
                                ...
                                <div class="resource-time">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b-res" id="mPubEairBResYes" :checked="time21Checked" @click="pstTimeresourcesFn0"><label for="mPubEairBResYes" class="input-label">有</label>
                                    </div>
                                ...
                                <div class="resource-others">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b-res" id="mPubEairBWait" :checked="time22Checked" @click="pstTimeresourcesFn1"><label for="mPubEairBWait" class="input-label">待协调</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b-res" id="mPubEairBEnough" :checked="time23Checked" @click="pstTimeresourcesFn2"><label for="mPubEairBEnough" class="input-label">时刻充足</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="arrive item" v-show="second3Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c" id="mPubEairCYes" @change="arrvAcceptnearairport = 0"><label for="mPubEairCYes" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c" id="mPubEairCNo" checked @change="arrvAcceptnearairport = 1"><label for="mPubEairCNo" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
                                ...
                                <div class="resource-time">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c-res" id="mPubEairCResYes" :checked="time31Checked" @click="arrvTimeresourcesFn0"><label for="mPubEairCResYes" class="input-label">有</label>
                                    </div>
                                ...
                                <div class="resource-others">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c-res" id="mPubEairCWait" :checked="time32Checked" @click="arrvTimeresourcesFn1"><label for="mPubEairCWait" class="input-label">待协调</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c-res" id="mPubEairCEnough" :checked="time33Checked" @click="arrvTimeresourcesFn2"><label for="mPubEairCEnough">时刻充足</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="right item-child">
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <div class="vertical-center" style="margin-bottom: 10px;">
                                    <input type="radio" class="magic-radio" name="subsidy" id="mPubEsubsidyYes" :checked="subsidy1" @click="subsidyClick0"/><label for="mPubEsubsidyYes" class="input-label">有补贴</label>
                                ...
                                <div style="display: flex">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="subsidy" id="mPubEsubsidyNo" :checked="subsidy2" @click="subsidyClick1"/><label for="mPubEsubsidyNo" class="input-label">无补贴</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="subsidy" id="mPubEsubsidyTalk" :checked="subsidy3" @click="subsidyClick2"/><label for="mPubEsubsidyTalk" class="input-label">可面谈</label>
                                    </div>
                                </div>
                            </div>
                        </div>
...
//                sendData: {},
        ...
        methods: {
            ...
            acceptDataFn: function () {
                /*单选按钮是否选定*/
                let mPubEairAYes = document.getElementById('mPubEairAYes');
                let mPubEairANo = document.getElementById('mPubEairANo');
                let mPubEairAResYes = document.getElementById('mPubEairAResYes');
                let mPubEairAWait = document.getElementById('mPubEairAWait');
                let mPubEairAEnough = document.getElementById('mPubEairAEnough');
                let mPubEairBYes = document.getElementById('mPubEairBYes');
                let mPubEairBNo = document.getElementById('mPubEairBNo');
                let mPubEairBResYes = document.getElementById('mPubEairBResYes');
                let mPubEairBWait = document.getElementById('mPubEairBWait');
                let mPubEairBEnough = document.getElementById('mPubEairBEnough');
                let mPubEairCYes = document.getElementById('mPubEairCYes');
                let mPubEairCNo = document.getElementById('mPubEairCNo');
                let mPubEairCResYes = document.getElementById('mPubEairCResYes');
                let mPubEairCWait = document.getElementById('mPubEairCWait');
                let mPubEairCEnough = document.getElementById('mPubEairCEnough');
                let mPubEsubsidyYes = document.getElementById('mPubEsubsidyYes');
                let mPubEsubsidyNo = document.getElementById('mPubEsubsidyNo');
                let mPubEsubsidyTalk = document.getElementById('mPubEsubsidyTalk');
