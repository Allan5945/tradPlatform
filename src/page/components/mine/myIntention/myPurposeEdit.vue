                    ...
                    <div class="second" v-show="secondShow">
                            ...
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a" id="mPubEairAYes" :checked="accept11Checked" @change="dptAcceptnearairportFn0"><label for="mPubEairAYes" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-a" id="mPubEairANo" :checked="accept12Checked" @change="dptAcceptnearairportFn1"><label for="mPubEairANo" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pass item" v-show="second2Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b" id="mPubEairBYes" :checked="accept21Checked" @change="pstAcceptnearairportFn0"><label for="mPubEairBYes" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-b" id="mPubEairBNo" :checked="accept22Checked" @change="pstAcceptnearairportFn1"><label for="mPubEairBNo" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
                        ...
                        <div class="arrive item" v-show="second3Show">
                            <div class="sec-accept">
                                ...
                                <div class="bottom">
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c" id="mPubEairCYes" :checked="accept31Checked" @change="arrvAcceptnearairportFn0"><label for="mPubEairCYes" class="input-label">是</label>
                                    </div>
                                    <div class="vertical-center">
                                        <input type="radio" class="magic-radio" name="airport-c" id="mPubEairCNo" :checked="accept32Checked" @change="arrvAcceptnearairportFn1"><label for="mPubEairCNo" class="input-label">否</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sec-resource">
