<template>
    <div class="t-form scroll popup" id="transForm" @click="closeDialog">
        <div class="select-box" v-show="formFinish">
            <div class="check-box"><input type="checkbox" id="zhankai" v-model="allFormShow"></div>
            <!-- <singleElection :single.sync="elect" class="checkbox-choose"></singleElection> -->
            <label for="zhankai">展开填写完整需求订单</label>
        </div>
        ...
        <div class="t-all" v-show="allFormShow">
         ...
         <div class="form-box">
             ...
             <div  style="width:200px;position:relative;">
              <!--   <span class="icon-item icon-item1" style="position:absolute;right:0;top:0;z-index:33;" @click="this.$refs.focus()">&#xe605;</span> -->
                <!-- <el-time-picker
                  ref="picker"
                  is-range
                  size="mini"
            ...
            <div class="post-type" v-show="!isAgent">
                <div class="t-radio">
