    ...
    <div class="ald-container" v-cloak>
            ...
            <div class="third item-container">
                <div class="start item">
                    ...
                    <div class="item-e" v-if="myData.dptState == 0 && myData.dptNm != null && myData.dptNm != ''">
                        ...
                        <span v-else-if="myData.dptTimeresources == 1">待协调</span>
                        <span v-else-if="myData.dptTimeresources == 2">时刻充足</span>
                    </div>
                </div>
                <div class="item-icon">
                ...
                <div class="pass item">
                    ...
                    <div class="item-e" v-if="myData.pstState == 0 && myData.pstNm != null && myData.pstNm != ''">
                        ...
                        <span v-else-if="myData.pstTimeresources == 1">待协调</span>
                        <span v-else-if="myData.pstTimeresources == 2">时刻充足</span>
                    </div>
                </div>
                <div class="item-icon">
                    <span class="icon-item">&#xe672;</span>
        ...
        <div class="first-button" v-if="firstButtonShow">
            ...
            <div class="buttons">
                ...
                <button class="btn btn-w" v-if="isAlreadyCollect == false" @click="addCollectFn" key="shoucang">收藏</button>
                <button class="btn btn-b" v-if="isAlreadyCollect == true" @click="cancelCollectFn" key="yishoucang" @mouseover="cancelCollectOver1Fn" @mouseout="cancelCollectOut1Fn" ref="cancelCollect1" style="width: 100px;">已收藏</button>
            </div>
        </div>
