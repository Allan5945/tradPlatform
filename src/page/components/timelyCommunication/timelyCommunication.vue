        ...
        <div class="timely-content">
            ...
            <div class="timely-content-body"> 
                ...
                <div class="chat-detailed" v-else>
                  <div class="chat-detailed-item">
                    <div class="chat-detailed-title"><span>意向反馈</span>2017.08.01  12:07</div>
                    <div class="chat-detailed-text popup">您已经被“北京-成都航线需求”选定，确认后，收到意向金</div>
